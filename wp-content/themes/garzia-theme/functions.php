...
function enqueue_js() {
    ...
    wp_enqueue_script( 'bs', get_template_directory_uri().'/vendors/js/jquery.min.js', array( 'jquery' ), '', true );
    wp_enqueue_script( 'bs', get_template_directory_uri().'/vendors/js/bootstrap.js', array( 'jquery' ), '', true );
    wp_enqueue_script( 'bs', get_template_directory_uri().'/vendors/js/bootstrap.min.js', array( 'jquery' ), '', true );
    wp_enqueue_script( 'bs', get_template_directory_uri().'/vendors/js/npm.js', array( 'jquery' ), '', true );
